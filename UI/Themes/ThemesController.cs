...
namespace REghZy.Themes {
    public static class ThemesController {
        ...
        public static void SetTheme(ThemeType theme) {
            ...
            ThemeDictionary = new ResourceDictionary() { Source = new Uri($"Themes/Themes/{themeName}.xaml", UriKind.Relative) };
            ControlColours = new ResourceDictionary() { Source = new Uri("Themes/ThemesV2/ControlColours.xaml", UriKind.Relative) };
            Controls = new ResourceDictionary() { Source = new Uri("Themes/ThemesV2/Controls.xaml", UriKind.Relative) };
        }
